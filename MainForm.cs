...
namespace DreamsLive_Solutions_PresenterApp1
{
    public partial class MainForm : Form
    {
        ...
        private void btnStartPresentation_Click(object sender, EventArgs e)
        {
            ...
            PresentationForm presentationForm = new PresentationForm(selectedImagePath, targetScreen);
            presentationForm.FormClosed += (s, args) => {
            ...
            presentationForm.Show(); // Show non-modally
        }
